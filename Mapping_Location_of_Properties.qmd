---
title: "Spatial Analysis of Professional Airbnb Activity in London"
jupyter: python3
...
ax.set_title(
    "Professional Hosts (>=2 listings AND availability >=90 days) over Borough (red) and MSOA (black) Boundaries",
    fontsize=14
)
ax.axis("off")
plt.show()
...
# Project both prof-host listings and borough boundaries to British National Grid
gdf_prof_hosts = gdf_prof_hosts.to_crs(epsg=27700) 
...
# ====== Step 5: Normalize counts by borough area (per km²) ======
