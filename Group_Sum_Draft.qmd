...
A final way in which Airbnb may be considered “out of control” is through its neighbourhood impacts. Even when hosts comply with regulations, the cumulative presence of short-term rentals can reshape local housing and social conditions. Research in cities such as Barcelona like that of Garcia-López et al., (2020) show that the effects typically emerge gradually rather than suddenly, but they contribute to a sense of housing insecurity among existing residents.

Beyond affordability, neighbourhoods with significant short-term rental activity report increased noise and nuisance complaints, reflecting the churn of transient visitors (Sheppard & Udell, 2016). Residents also note shifts in local services, as shops and amenities begin to cater more to tourists than to long-term communities (Cocola-Gant, 2016). Such changes alter the everyday character of an area even without widespread illegality or explicit commercialisation.
